...
@include('partials.nav_links')
    ...
    <div class="row">
        ...
        <div class="blog-post my-2">
          ...
          <p>Mleko od banane i pistaća, proizvodi sa leblebijama umesto brašna, pesto od kelja, kafa sa proteinom, pogledajte kakve nam još trendove donosi 2021. godina.</p>
          <hr>
          <p class="main-text my-3">Po ko zna koji put možemo reći da je zdrava hrana definitivno došla da ostane. Kada kažemo zdrava hrana, mislimo na sve veću popularnost kvalitetnih,
               nutritivno bogatih namirnica u skladnoj i promišljenoj ishrani. <span>U 2021. godini</span> U 2021. godini neće biti mnogo razlike u odnosu na 2020. kada su u pitanju trendovi u ishrani. Ipak,
                ističu popularni nutricionisti, fokus na određene tipove ishrane i namirnica će znatno porasti. <b> Personalizovana ishrana, intuitivna ishrana, detoksikacija hranom i
                 keto ishrana </b> kao i održivi sistemi u ishrani obeležiće i <b>2021. godinu.</b>  </p>
            <img src="/uploads/trend1.jpeg" alt="" class="trend-photo">

          <p class="my-4 main-text">Kada su u pitanju namirnice, najveći svetski sajmovi hrane poput World Food sajmova i Biofach sajma potvrdili su ove trendove.
               Na sajmovima veliku pažnju su privukli visokokvalitetni organski mlečni proizvodi, biljna mleka, te mleka sa omega masnim kiselinama i prebioticima.
          ...
          <h5 class="my-4"> <b> Evo šta će sve biti popularno u 2020. godini kada su namirnice u pitanju. </b></h5>

          <h3 class="my-4">#1 Povrće umesto šećera i zgušnjivača u dodacima za kuvanje</h3>
          <p class="main-text">Iako će vam mnogi stručnjaci reći kako je prirodno povrće najbolje i kako sve što dolazi u kutiji treba izbegavati, trendovi u proizvodnji namirnica to možda
              ipak mogu da promene. Tehnologija se razvija i povrće ipak može stići do vas u pogodnoj varijanti. <br>
            Primera radi, pojedini proizvođači kečapa će od sada umesto šećera i zgušnjivača u kečap uključivati čitavu paletu povrća,
            uključujuči šargarepu, papriku, batat, tikvu, luk i cveklu. Cilj uključivanja ovakvog povrća osim nutritivne vrednosti jeste izbegavanje veštačkih aroma i emulgatora.
            ...
            <p class="main-text">Stidljivi karfiol koji se kuvao samo u čorbama i paprikašima, sada je ponosni sastojak pica i mrvica za pohovanje mesa. </p>
            <img src="/uploads/karfiol.jpeg" alt="" class="trend-photo">
            <p class="main-text my-3">Kore za picu od karfiola će biti sve popularnije. <span> Mleveni karfiol </span>uveliko zamenjuje hlebne mrvice pa čak i brašno, a može se naći
                ...
                Kada su u pitanju <span>leblebije </span>, brašno od ove namirnice se polako popularizuje i u Srbiji i u ponudi su čak i organske leblebije.  </p>

            <h3 class="my-4">#3 Hrana sa pojačanim unosom vitamina D</h3>
            <p class="main-text">Manjak vitamina D nije retka pojava kod ljudi zbog čega nije ni čudo su se proizvođači hrane dosetili da ovaj nedostatak isprave hranom.

                Musli, razne kombinacije žitarica za doručak neretko imaju dodat vitamin D. Sada je to prisutno više nego ikad i takve kombinacije će biti sve češće.</p>
